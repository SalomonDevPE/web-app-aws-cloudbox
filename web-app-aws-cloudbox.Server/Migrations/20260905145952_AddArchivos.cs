...
{
    /// <inheritdoc />
    public partial class AddArchivos : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Archivos_Folders_FolderId",
                        column: x => x.FolderId,
                        principalTable: "Folders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Archivos_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Archivos_FolderId",
                table: "Archivos",
                column: "FolderId");

            migrationBuilder.CreateIndex(
                name: "IX_Archivos_UserId",
                table: "Archivos",
                column: "UserId");
        }
